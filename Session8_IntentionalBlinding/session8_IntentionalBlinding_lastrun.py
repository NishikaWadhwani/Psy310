...
expName = 'session8_IntentionalBlinding'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\PsychoPy_Tutorial\\Session8_IntentionalBlinding\\session8_IntentionalBlinding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=28.0, method='random', 
