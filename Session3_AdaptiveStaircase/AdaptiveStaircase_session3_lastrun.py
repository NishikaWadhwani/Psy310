...
expName = 'AdaptiveStaircase_session3'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\PsychoPy_Tutorial\\Session3_AdaptiveStaircase\\AdaptiveStaircase_session3_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # Run 'Begin Experiment' code from fiftyfifty
