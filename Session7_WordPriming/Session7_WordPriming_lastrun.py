...
expName = 'Session7_WordPriming'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\PsychoPy_Tutorial\\Session7_WordPriming\\Session7_WordPriming_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    slider = visual.Slider(win=win, name='slider',
        ...
        labels=["familar", "unfamiliar"], ticks=(1, 2, 3, 4, 5), granularity=0.0,
