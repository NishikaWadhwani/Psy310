...
expName = 'Session5_VisualSearch'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\PsychoPy_Tutorial\\Session5_VisualSearch\\Session5_VisualSearch_lastrun.py',
