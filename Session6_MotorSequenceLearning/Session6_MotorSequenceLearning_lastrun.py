...
expName = 'Session6_MotorSequenceLearning'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\PsychoPy_Tutorial\\Session6_MotorSequenceLearning\\Session6_MotorSequenceLearning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=50.0, method='sequential', 
        ...
        trialList=data.importConditions('Sequence_condiotion.csv'),
